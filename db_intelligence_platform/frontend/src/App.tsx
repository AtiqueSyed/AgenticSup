...
function Dashboard() {
  const [stats, setStats] = useState({ total_databases: 0, entities_identified: 0, queries_today: 0 })
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <h3 className="font-medium text-lg text-slate-900">Total Databases</h3>
