...
export default function DatabaseOnboarding() {
  const [connectionString, setConnectionString] = useState("oracle+oracledb_async://C%23%23agenticsupervisor_cims:agenticsupervisor@host.docker.internal:1522/?service_name=XE")
